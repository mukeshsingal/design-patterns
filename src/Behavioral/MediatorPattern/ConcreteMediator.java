...
public class ConcreteMediator implements Mediator {
    ...
    private Map<String, Component> regComponetMap = new HashMap<>();
    ...
    public void register(Component component) {
        regComponetMap.put(component.getName(), component);
    }

    private void reactOnA(String message) {
        System.out.println("Mediator is in Action");
        regComponetMap.get(COMPONENT_B).receive(message);
    }

    private void reactOnB(String message) {
        System.out.println("Mediator is in Action");
        regComponetMap.get(COMPONENT_A).receive(message);
    }
}
